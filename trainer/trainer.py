...
# Disable tensorboard for simplicity
...
class Trainer(object):
    ...
    def train(self, model):
        """Complete training process with early stopping support"""
    ...
    def evaluate(self, model, epoch_idx=None):
        ...
        if hasattr(self.data_handler, 'valid_dataloader'):
            ...
            raise NotImplementedError("No valid_dataloader or test_dataloader found")
        return eval_result
    ...
    def test(self, model):
        ...
        if hasattr(self.data_handler, 'test_dataloader'):
            ...
            raise NotImplementedError("No test_dataloader found")
        return eval_result
